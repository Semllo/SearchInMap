 ...
 */
public ColaPrioridad(final Comparator<T> c)
{
...
public void remove(T e)
{
    ...
    if(!set.remove(e))
    {
        // Esto no debería ocurrir, porque aunque el objeto 'Comparable'
        // no sea consistente con 'equals' no se añaden estados repetidos.
        // Todavía no hemos averiguado por qué ocurre esto.

        // From lost to the river:
        // Buscamos el estado secuencialmente y lo borramos.
